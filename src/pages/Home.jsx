                        ...
                        <div className="flex flex-col gap-4 mt-4">
                            <div className={recentBlogRow}>
                                ...
                                <div>
                                    ...
                                    <p className={topProgramBlogText}>You're free to use this website template without linking back to us.If you're having problems editing this website template, then don't hesitate to ask for help on the Forums... <Link to="/blog" className={readMoreButton}>Read More</Link></p>
                                </div>
                            </div>
                            ...
                            <div className={recentBlogRow}>
                                ...
                                <div>
                                    ...
                                    <p className={topProgramBlogText}>You can do a lot with them. You can modify them. You can use them to design websites for clients, so long as you agree with the Terms of Use. You can even remove all our... <Link to="/blog" className={readMoreButton}>Read More</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
